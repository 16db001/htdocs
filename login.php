<?php
	...
	if(isset($_POST['login'])) {
		...
		if($errMsg == '') {
			try {
				$stmt = $pdo->prepare('SELECT id, fullname, username, password, secretpin FROM pdo WHERE username = :username');
				$stmt->execute(array(
					':username' => $username
					));
...
<body>
	<div align="center">
		<div style=" border: solid 1px #006D9C; " align="left">
			...
			?>
			<div style="background-color:#006D9C; color:#FFFFFF; padding:10px;"><b>ログイン</b></div>
